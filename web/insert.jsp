<%-- 
    Document   : insert
    Created on : 30 Nov, 2018, 9:53:34 PM
    Author     : Sunil
--%>
...
<html>
    ...
    <body>
       <center>      
        ...
        <br><br><form action="insert1.jsp">
         <h3> <table align="center"><br>       
                <tr>
                     <td>BRANCH ID : </td>
                     <td><input type ="textbox" name="n2" size="25" value=""></td>
                 </tr><br>
                 <tr> 
                     <td>BRANCH NAME :</td>
                     <td><input type ="textbox" name="m2" size="25" value=""></td>
                 </tr> 
             </table></h3><br>
         <input style="font-size: 130%" type="submit" value="INSERT"/>
            </form>
       </center>
    </body>
</html>
